...
function login() {
  ...
  user.name = document.getElementById("loginForm").elements.item(0).value;
  user.password = document.getElementById("loginForm").elements.item(1).value;
...
function signUp() {
  ...
  if (n == 0) {
    alert("please compleat the form");
  } else if (n < 6) {
...
function changePass() {
  alert("Your old password is " + cred[active]);
  cred[active] = document.getElementById("changePass").elements.item(0).value;
  alert("your new password is " + cred[active]);
  alert("The password was changed but It will not stay when JS refreshes");
}

function recover() {
  let auth = firebase.auth();
  let emailAddress = "hey";
  emailAddress = prompt("Enter your email", "Email")
...
function postComment() {
  ...
  comm = document.getElementById("comm").elements.item(0).value;
  comm = active + " " + date + " " + comm;
  comment1.push(comm);
}
